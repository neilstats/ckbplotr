...
The function has several arguments that allow for customization of appearance and layout. For example: use `ext` to set the file extension (and also format); set `landscape = TRUE` to create a landscape page; and set `cropped = TRUE` to also save a plot without additional margins, title or footer.
