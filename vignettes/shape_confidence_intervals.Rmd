...
## Changing the colour
To plot short confidence widths a different colour, set the `height` argument of `shape_plot()` (this will also fix the height of the plot). The `cicolour` argument should also be a character vector - the last element will be used for short confidence intervals.
