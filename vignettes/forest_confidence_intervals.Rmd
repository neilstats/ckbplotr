...
## Changing the colour
To plot narrow confidence widths a different colour, set the `panel.width` argument of `forest_plot()` (this will also fix the width of each panel). The `cicolour` argument should also be a character vector - the last element will be used for narrow confidence intervals.
