...
ggplot(datatoplot, aes(y=-row, x=estimate_transformed)) +
  ...
  ## column textresult
  geom_text(aes(y = -row, x = 1.104423626284,
            label = textresult),
            hjust = 0,
            size = 3,
            na.rm = TRUE,
  ...
  ## column n
  geom_text(aes(y = -row, x = 0.896395166165542,
                label = `n`,
            fontface = "plain"),
           hjust = 1,
           size = 3,
...
events",
  ...
  geom_text(aes(y = -Inf, x = 0.99498743710662, label = xlab),
            hjust = 0.5,
            size  = 3,
            vjust = 4.4,
            fontface = "bold",
