...
plot_like_ckb <- function(
  ...
  plot +
    ...
    theme(panel.grid        = element_blank(),
          ...
          axis.text.x       = element_text(margin = margin(t = 4.4), vjust = 1),
          axis.text.x.top   = element_text(margin = margin(b = 4.4), vjust = 0),
          axis.text.y       = element_text(margin = margin(r = 4.4), hjust = 1),
          axis.text.y.right = element_text(margin = margin(l = 4.4), hjust = 0),
